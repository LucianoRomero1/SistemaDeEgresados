...
class Graduado
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=TitulacionesAlcanzadas::class, mappedBy="graduado", cascade={"persist", "remove"})
     */
    ...
    public function removeTitulacione(TitulacionesAlcanzadas $titulacione): self
    {
        if ($this->titulaciones->removeElement($titulacione)) {
            ...
            if ($titulacione->getGraduado() === $this) {
